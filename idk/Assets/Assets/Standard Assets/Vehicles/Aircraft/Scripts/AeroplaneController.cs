...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    {
        [SerializeField] private float m_MaxEnginePower = 40f;        // The maximum output of the engine. A l'origine la valeur était de 40. 
        [SerializeField] private float m_Lift = 0.002f;               // The amount of lift generated by the aeroplane moving forwards. traduction : La quantité de portance générée par le déplacement de l'avion vers l'avant.
        [SerializeField] private float m_ZeroLiftSpeed = 300;         // The speed at which lift is no longer applied. traduction : La vitesse à laquelle la levée n'est plus appliquée.
        [SerializeField] private float m_RollEffect = 1f;             // The strength of effect for roll input. traduction : La force de l'effet pour la roulis.
        [SerializeField] private float m_PitchEffect = 1f;            // The strength of effect for pitch input. traduction : La force de l'effet de tangage.
        [SerializeField] private float m_YawEffect = 0.2f;            // The strength of effect for yaw input. traduction : La force de l'effet en tangage.
        [SerializeField] private float m_BankedTurnEffect = 0.5f;     // The amount of turn from doing a banked turn. traduction : Le nombre de tours d'un virage incliné.
